...
public void main() throws EmailException{
	...
	//message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("sakthi.priyan@vakilsearch.com"));
			...
			message.setSubject("LeadCreation2nd set Automation");

			// Create object to add multimedia type content
			BodyPart messageBodyPart1 = new MimeBodyPart();

			// Set the body of email
			messageBodyPart1.setText("GST Filings and Goods & Service Tax Registration");

			// Create another object to add another content
			MimeBodyPart messageBodyPart2 = new MimeBodyPart();
			//"C:\\Users\\admin\\git\\Automation-Critical-Flow\\GRCCriticalflow\\Screenshots"
			// Mention the file which you want to send
			String filename = "\\\\14.140.167.188\\Vakilsearch\\AutomatonLeadCreation2\\" + Date1 + "\\extentreport.html";
